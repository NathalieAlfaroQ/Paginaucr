import svgPaths from "./svg-cnatf5tv9c";
...
function PieDePagina() {
  return (
    <footer className="absolute bg-[#595959] block bottom-0 h-[155px] left-0 overflow-clip right-0" data-name="Pie de página">
      <Frame1 />
      <Frame />
    </footer>
  );
...
function FirmaUcrC() {
  return (
    <div className="absolute bottom-[26px] content-stretch flex flex-col items-start left-[40px] overflow-clip px-[40px] top-[26px] w-[512px]" data-name="firma-ucr-c 1">
      <TextoUcr1 />
    </div>
  );
}
...
function Cintillo() {
  return (
    <nav className="bg-[#00c0f3] block h-[80px] overflow-clip relative shrink-0 w-full" data-name="Cintillo">
      <FirmaUcrC />
    </nav>
  );
}
...
function BarraDeNavegacion() {
  return (
    <div className="content-stretch flex h-[30px] items-center relative shrink-0 w-full" data-name="Barra de navegación">
      <button className="bg-white block cursor-pointer h-[30px] overflow-clip relative shrink-0 w-[250px]" data-name="Página Principal con opciones de usuario - Escritorio">
      ...
      <div className="bg-white flex-[1_0_0] h-full min-w-px overflow-clip relative">
        <div className="absolute bg-[#d9d9d9] inset-0" />
        <div className="absolute flex flex-col font-['EB_Garamond:Regular',sans-serif] font-normal inset-[10%_4.8%_13.33%_4.4%] justify-center leading-[0] text-[20px] text-black text-center">
...
function Frame2() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-0 w-[1280px]">
      <Cintillo />
      <BarraDeNavegacion />
    </div>
  );
...
function CampoDeEntrada() {
  return <div className="bg-white h-[40px] shrink-0 w-full" data-name="Campo de entrada" />;
}
...
function ConetnedorDelCampo1() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full" data-name="Conetnedor del campo">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[20px] text-black w-full">Cédula</p>
      <CampoDeEntrada1 />
    </div>
  );
}

function CampoDeEntrada2() {
  return <div className="bg-white h-[40px] shrink-0 w-full" data-name="Campo de entrada" />;
}

function ConetnedorDelCampo2() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full" data-name="Conetnedor del campo">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[20px] text-black w-full">Celular</p>
      <CampoDeEntrada2 />
    </div>
  );
}

function CampoDeEntrada3() {
  return <div className="bg-white h-[40px] shrink-0 w-full" data-name="Campo de entrada" />;
}

function ConetnedorDelCampo3() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full" data-name="Conetnedor del campo">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[20px] text-black w-full">Correo</p>
      <CampoDeEntrada3 />
    </div>
  );
}

function TarjetaDePlaza() {
  return (
    <div className="bg-[#d9d9d9] relative rounded-[10px] shrink-0 w-full" data-name="Tarjeta de plaza">
      <div className="content-stretch flex flex-col gap-[10px] items-start pb-[13px] pt-[12px] px-[11px] relative size-full">
        <div className="content-stretch flex flex-col h-[69px] items-start relative shrink-0 w-full" data-name="Campo de entrada dinámico">
          <ConetnedorDelCampo />
        </div>
        <div className="content-stretch flex flex-col h-[69px] items-start relative shrink-0 w-full" data-name="Campo de entrada dinámico">
          <ConetnedorDelCampo1 />
        ...
        <div className="bg-[#a6a2a2] relative rounded-[10px] shrink-0 w-full" data-name="Guardar plaza">
...
function Cuerpo() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] items-start left-[143px] right-[157px] top-[200px]" data-name="Cuerpo">
      <div className="font-['Inter:Regular',sans-serif] font-normal h-[36px] leading-[0] not-italic relative shrink-0 text-[30px] text-black w-full">
        <p className="leading-[normal] mb-0">Crear usuario</p>
...
export default function Desktop() {
  return (
    <div className="bg-white relative size-full" data-name="Desktop">
      <div className="absolute inset-0 overflow-clip" data-name="Página Principal con opciones de usuario - Escritorio">
        <PieDePagina />
        <Frame2 />
      </div>
      <Cuerpo />
