import svgPaths from "./svg-3otc2l6diu";
...
function Frame5() {
  return (
    <div className="h-[246px] relative shrink-0 w-[262px]">
      <div className="absolute bottom-0 left-0 top-[57px] w-[202px]">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 202 189">
          <path d={svgPaths.p3fe669f0} fill="var(--fill-0, #D9D9D9)" id="Ellipse 1" />
        </svg>
      </div>
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal h-[36px] leading-[normal] left-[calc(50%-131px)] not-italic text-[30px] text-black top-0 w-[262px]">Perfil</p>
    </div>
  );
}

function Frame() {
  return <div className="absolute bg-gradient-to-r from-[#d9d9d9] inset-[36px_0_7px_0] to-[#d9d9d9]" />;
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start overflow-clip relative shrink-0 w-full">
      <div className="h-[65px] relative shrink-0 w-full">
        <div className="absolute bg-white h-[65px] left-0 top-0 w-[250px]" />
        <Frame />
        <p className="absolute bottom-[34px] font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[20px] text-black top-[8px] w-[84px]">Nombre</p>
      </div>
      <div className="h-[65px] relative shrink-0 w-full">
        <div className="absolute bg-white h-[65px] left-0 top-0 w-[250px]" />
        <Frame1 />
        <p className="absolute bottom-[34px] font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[20px] text-black top-[8px] w-[84px]">Cédula</p>
      </div>
      <div className="h-[65px] relative shrink-0 w-[618px]">
        <div className="absolute bg-white h-[65px] left-0 top-0 w-[250px]" />
        <Frame2 />
        <p className="absolute bottom-[34px] font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[20px] text-black top-[8px] w-[84px]">Celular</p>
      </div>
      <div className="h-[65px] relative shrink-0 w-[618px]">
        <div className="absolute bg-white h-[65px] left-0 top-0 w-[250px]" />
        <Frame3 />
        <p className="absolute bottom-[34px] font-['Inter:Regular',sans-serif] font-normal leading-[normal] left-0 not-italic text-[20px] text-black top-[8px] w-[84px]">Correo</p>
      </div>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[20px] h-[640px] items-start left-1/2 top-1/2 w-[620px]">
      <Frame5 />
      <Frame4 />
      <button className="bg-[#a6a2a2] cursor-pointer relative rounded-[10px] shrink-0 w-full">
...
export default function MainFrame() {
  return (
    <main className="bg-white block relative size-full" tabIndex="-1" data-name="Main Frame">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[1080px] left-1/2 overflow-clip top-1/2 w-[1280px]" data-name="Página Principal con opciones de usuario - Escritorio">
        <PieDePagina />
        <Frame9 />
      </div>
      <Frame6 />
