  ...
  return (
    <div className="flex flex-col gap-[40px] w-[940px] mx-auto" style={{fontFamily: "'Inter', sans-serif"}}>
      ...
      <div className="flex gap-[10px] w-full">
        <Link to="/app/declaration" className="flex-1 bg-[#a6a2a2] hover:bg-[#8e8a8a] py-[12px] rounded-[10px] transition-colors cursor-pointer text-center border-none no-underline block text-black text-[20px] leading-[normal]">
          ← Regresar
        </Link>
        <button className="flex-1 bg-[#a6a2a2] hover:bg-[#8e8a8a] py-[12px] rounded-[10px] transition-colors cursor-pointer text-center border-none">
          <Link to="/app/declaration/questions-2" className="text-[20px] leading-[normal] text-black no-underline block">Guardar y Continuar →</Link>
        </button>
