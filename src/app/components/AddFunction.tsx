...
export function AddFunction() {
  return (
    <div className="flex flex-col gap-[20px] items-start w-[554px] mx-auto mt-20" style={{fontFamily: "'Inter', sans-serif"}}>
      <p className="font-normal leading-[normal] text-[30px] text-black">Agregar función</p>
      <div className="bg-[#d9d9d9] flex flex-col gap-[20px] items-start p-[20px] rounded-[10px] w-full">
        <div className="flex flex-col gap-[5px] w-full">
          <p className="font-normal leading-[normal] text-[20px] text-black">Función</p>
          <select className="bg-white h-[40px] px-[20px] w-full outline-none text-[20px] cursor-pointer border-none">
